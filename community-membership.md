...
- [Open an
  issue](https://github.com/radius-project/community/issues/new?template=membership.md&title=REQUEST%3A%20New%20membership%20for%20%3Cyour-GH-handle%3E)
  against the
  [Radius/community](https://github.com/radius-project/community) repo
  - Ensure your sponsors are `@mentioned` on the issue
  - Complete every item on the checklist ([preview the current version of the
    template](https://github.com/radius-project/community/blob/main/.github/ISSUE_TEMPLATE/membership.md))
